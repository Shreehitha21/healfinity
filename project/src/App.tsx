...
import { Bell, Home, Heart, Video, Apple, BookOpen, User, Menu, X, Search, LogOut, Zap } from 'lucide-react';
...
type Page = 'dashboard' | 'remedies' | 'consultation' | 'tracking' | 'diet' | 'profile' | 'search' | 'yoga';

function AppContent() {
  const { currentUser, logout, addConsultation, updateHealthData, addYogaSession } = useAuth();
